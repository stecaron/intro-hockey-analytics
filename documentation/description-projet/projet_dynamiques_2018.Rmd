...
On trouve le centroïde, ou la valeur centrale, de chacun des groupes. Ces valeurs sont illustrées par des triangles. Les points ronds sont les données que nous voulons groupées bien sûr.
